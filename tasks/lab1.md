...
1. Если *не удалось освободить ресурсы логгера* (код возврата fini_logger = 1), то программа должна написать в stderr сообщение:<br>
<code>"Couldn't shut down logger\n"</code><br> После этого завершить работу с кодом возврата 1.
1. Если *не удалось освободить ресурсы логгера* (код возврата destroy_config_tables = 1), то программа должна написать в stderr сообщение:<br>
<code>"Couldn't shut down config\n"</code><br> После этого завершить работу с кодом возврата 1.
