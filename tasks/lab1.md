...
1. Если *не удалось проинициализировать конфиг* (код возврата create_config_tables = 1), то программа должна написать в stderr сообщение:
```C
...
```
после этого завершить работу с кодом возврата 1.
1. Если *не удалось освободить ресурсы логгера* (код возврата destroy_config_tables = 1), то программа должна написать в stderr сообщение:
```C
"Couldn't shut down logger\n"
```
после этого завершить работу с кодом возврата 1.
