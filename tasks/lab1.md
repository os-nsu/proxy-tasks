...
На эти вопросы вы можете найти ответы в представленной ниже литературе. Их не будут спрашивать при сдаче, но найти ответ на
них будет полезно для саморазвития
...
1. Как настроить компоновщик, чтобы сохранились
...
1. Система плагинов:
    1. Напишите тестовый плагин с именем "greeting" в соответствии с представленным интерфейсом (файл динамической библиотеки плагина должен называться так: "название плагина".so);
...
1. Написать статическую библиотеку конфига в соответствии с интерфейсом:
    1. Реализуйте из него функцию (и только её) int create_config_table(void). Она должна просто возвращать ноль и не делать больше ничего.
