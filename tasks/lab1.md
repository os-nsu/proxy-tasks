...
>и чтобы по цепочке выполнились все определенные в плагинах реализации хуков. Для такого, например,
>можно в init сохранять в глобальную переменную плагина предыдущее значение указателя на хук,
>а затем записывать указатель на хук плагина. Тогда в хуке можно будет сначала вызывать функцию
>по этому предыдущему значению, а затем выполнять логику хука.
