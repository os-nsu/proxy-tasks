...
#### Теоретические вопросы
    ...
    2. Что такое elf файл и какие его виды бывают?
...
#### Задания (порядок выполнения не важен)
    1. Система плагинов:
        a. Напишите тестовый плагин с именем "task_manager" в соответсвии с представленным интерфейсом (файл динамической библиотеки плагина должен называться так: "название плагина".so);
        b. Загрузите этот плагин в основной программе (название захардкодте);
